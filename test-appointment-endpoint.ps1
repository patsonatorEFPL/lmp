# Script de test pour l'endpoint de création de rendez-vous
...
function Test-AvailableSlots {
    ...
    try {
        Write-Host "`nTest de récupération des créneaux disponibles..."
        $response = Invoke-WebRequest -Uri "$baseUrl/appointments/available-slots?date=2025-01-15" -Method GET -WebSession $csrfInfo.Session -ErrorAction Stop
...
Write-Host "=== Test des endpoints de rendez-vous ==="
Test-AvailableSlots
