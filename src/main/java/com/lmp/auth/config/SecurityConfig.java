...
public class SecurityConfig {
     ...
     *
     * <p>Avant : {@code SessionRegistryImpl()} in-memory JVM. Cap
     * {@code MaximumSessions=2 per user} était par-instance ; en multi-replica
     * un user pouvait avoir {@code 2×N} sessions actives totales.</p>
     *
     * <p>Avec {@link SpringSessionBackedSessionRegistry}, sessions lues depuis
     * le repository Spring Session Redis ({@code @EnableRedisHttpSession} via
     * {@link com.lmp.shared.config.SessionConfig}) → vue cohérente cross-replica
