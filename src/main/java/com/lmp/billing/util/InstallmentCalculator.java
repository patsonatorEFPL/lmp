...
/**
 * Calcule les montants d'échéances en reproduisant exactement la logique ERPNext.
 * <p>
 * Formule ERPNext (accounts_controller.py l.2597) :
 * <pre>
 ...
 * <p>
 * Précision définie par {@link MoneyUtils} (alignée sur ERPNext).
 */
public final class InstallmentCalculator {
    ...
    /**
     * Calcule les montants d'échéances selon la méthode ERPNext.
     * <p>
    ...
    public static List<Installment> calculate(BigDecimal grandTotal, int count) {
        ...
        // ERPNext: floor(100/N, 2) — ex: 100/3 = 33.33
        ...
        // Calcul des N-1 premières échéances (formule ERPNext exacte)
        BigDecimal sumPrevious = BigDecimal.ZERO;
        for (int i = 1; i < count; i++) {
            // ERPNext formula: flt(grand_total * flt(invoice_portion) / 100, precision)
        ...
        // C'est ce que fait ERPNext via validate_payment_schedule_amount
