 ...
 * La conversion publie un QUOTATION_ACCEPTED qui déclenche côté ERPNext
...
public class QuotationService {
     ...
     * 3. Publie QUOTATION_ACCEPTED → ErpEventListener appelle make_sales_order sur ERPNext
     *
    ...
    public Order accept(UUID quotationId) {
        ...
        // 3. Publier l'événement — déclenche make_sales_order côté ERPNext
        eventPublisher.publishEvent(LmpBusinessEvent.of(
