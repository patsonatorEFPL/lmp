 ...
 * Mapping ERPNext :
 * <ul>
 *   <li>LMP DRAFT → ERPNext Draft (docstatus=0)</li>
 *   <li>LMP SENT → ERPNext Open (docstatus=1, submitted)</li>
 *   <li>LMP ACCEPTED → ERPNext Ordered (via make_sales_order API)</li>
 *   <li>LMP REJECTED → ERPNext Lost</li>
 *   <li>LMP EXPIRED → ERPNext Expired</li>
 * </ul>
 */
@Component
