 ...
 * Le module Integration les consomme et les transmet vers external ERP (futur).
 *
 * Couplage faible : les modules émetteurs ne connaissent ni external ERP, ni n8n.
...
public record LmpBusinessEvent(
     ...
     * Ajouter un nouveau type ici quand un nouveau flux external ERP est nécessaire.
     */
