...
public class SiteEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        // external CRM / external ERP callback : dérivé de lmp.crm.url (par défaut crm.lmp-services.ca)
        // permet à un environnement isolé de pointer vers une autre instance external CRM.
