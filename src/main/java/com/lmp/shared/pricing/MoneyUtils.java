 ...
 * <p>
 * Aligné sur la précision ERPNext (Currency precision = 2, HALF_UP).
...
public final class MoneyUtils {
    ...
    /** Précision des montants monétaires (EUR, USD, etc.) — ERPNext Currency field. */
    public static final int CURRENCY_SCALE = 2;

    /** Précision des pourcentages (invoice_portion, etc.) — ERPNext Percent field. */
    ...
    /** Arrondi standard pour les montants monétaires — identique à flt() dans ERPNext. */
     ...
     * Équivalent de {@code flt(value, precision("payment_amount"))} dans ERPNext.
     */
    ...
    /**
     * Calcule un pourcentage d'un montant — formule ERPNext exacte.
