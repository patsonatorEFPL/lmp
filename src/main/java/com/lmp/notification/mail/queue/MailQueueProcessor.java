...
import com.lmp.notification.mail.dispatch.MailDispatcher;
...
public class MailQueueProcessor {
    ...
    public MailQueueProcessor(EmailQueueRepository repository, MailDispatcher dispatcher) {
