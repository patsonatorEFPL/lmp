...
-- ============================================================================
-- Inspired by Frappe Email Queue but optimized:
--   * single-row claim via UPDATE...RETURNING (vs Frappe SELECT FOR UPDATE per row)
--   * 5s poll tick (vs Frappe 4-min cron tick)
--   * multi-replica safe by design (Frappe = single worker)
-- ============================================================================
...
-- Correlation lookup (for thread tracking equivalent of Frappe Communication link)
