-- =============================================
-- LMP — OAuth2 Authorization Server Tables
-- =============================================
-- Tables requises par Spring Authorization Server (JdbcRegisteredClientRepository,
-- JdbcOAuth2AuthorizationService, JdbcOAuth2AuthorizationConsentService).
-- Ref: https://docs.spring.io/spring-authorization-server/reference/guides/how-to-jpa.html

-- Table des clients OAuth2 enregistrés
...
-- Table des autorisations OAuth2 actives
...
-- Table des consentements OAuth2
