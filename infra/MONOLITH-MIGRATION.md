...
| `ERP_OAUTH2_REDIRECT_URI` | `http://localhost:8069/...` | `https://crm.lmp-services.ca/api/method/external CRM.integrations.oauth2_logins.custom/lmp_sso` |
...
| `ERP_OAUTH2_CLIENT_ID` | `external ERP-client` | `external CRM-erp-client` |
| `ERP_OAUTH2_CLIENT_SECRET` | `external ERP-secret` | `<rotate — match external CRM Social Login Key>` |
| `ERP_OAUTH2_REDIRECT_URI` | `http://localhost:8069/...` | `https://crm.lmp-services.ca/api/method/external CRM.integrations.oauth2_logins.custom/lmp_sso` |
...
## Phase 5 — Migration env → DB (external CRM-style, optionnel)
