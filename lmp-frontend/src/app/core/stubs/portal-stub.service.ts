...
const mkSync = (synced: boolean): Pick<Quotation, 'frappeId' | 'syncStatus' | 'lastSyncedAt'> =>
  synced
    ? { frappeId: `FRP-${Math.floor(Math.random() * 99999)}`, syncStatus: 'SYNCED', lastSyncedAt: '2026-04-15T09:00:00Z' }
    : { frappeId: null, syncStatus: 'PENDING', lastSyncedAt: null };
