...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <footer class="border-t border-white/5 bg-(--card)">
      <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3 items-start">
          <!-- Brand -->
          <div>
            <a routerLink="/" class="flex items-center gap-3">
              ...
              <span class="rounded-md bg-white/10 px-2 py-0.5 text-xs font-semibold uppercase tracking-wider text-(--muted-foreground)">
                Premium
              </span>
            </a>
            <p class="mt-4 max-w-xs text-sm leading-relaxed text-(--muted-foreground)">
              ...
              marketing digital. Nous aidons les entreprises à se démarquer
              et à prospérer.
            </p>
            <!-- Social Icons -->
            <div class="mt-5 flex items-center gap-3">
              ...
              <a
                href="#"
                aria-label="Twitter / X — LMP Digital Services"
                class="flex h-9 w-9 items-center justify-center rounded-full border border-(--border) text-(--muted-foreground) transition-colors hover:border-(--primary)/30 hover:text-(--primary)"
              >
              ...
              <a
                href="#"
                aria-label="LinkedIn — LMP Digital Services"
                class="flex h-9 w-9 items-center justify-center rounded-full border border-(--border) text-(--muted-foreground) transition-colors hover:border-(--primary)/30 hover:text-(--primary)"
              >
                <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                href="#"
                aria-label="Instagram — LMP Digital Services"
                class="flex h-9 w-9 items-center justify-center rounded-full border border-(--border) text-(--muted-foreground) transition-colors hover:border-(--primary)/30 hover:text-(--primary)"
              >
                <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <!-- Bottom strip -->
        <div class="mt-10 flex flex-col items-center justify-between gap-4 border-t border-(--border) pt-6 pb-2 sm:flex-row">
          <p class="text-xs text-(--muted-foreground)">
            © 2026 LMP (Local Map Profil). Tous droits réservés.
          </p>
          <div class="flex gap-6 sm:pr-44">
            <a
              routerLink="/privacy"
